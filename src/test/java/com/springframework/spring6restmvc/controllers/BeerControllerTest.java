...
class BeerControllerTest {
    ...
    void patchBeer() throws Exception {
        BeerDTO beer = beerServiceImpl.getAllBears(null, null, false).get(0);
    ...
    void createBear() throws Exception {
        ...
        given(beerService.saveBeer(any(BeerDTO.class)))
                .willReturn(beerServiceImpl.getAllBears(null, null, false).get(1));
    ...
    void getAllBears() throws Exception {
        given(beerService.getAllBears(null, null, false)).willReturn(beerServiceImpl.getAllBears(null, null, false));
    ...
    void getBeerById() throws Exception {
        BeerDTO testBeer = beerServiceImpl.getAllBears(null, null, false).get(0);
